                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        <header className="mb-8 flex justify-between items-end px-4">
                            <div>
                                <h2 className="text-white text-3xl font-black uppercase tracking-tighter">Employee Dashboard</h2>
                        ...
                        {activeSection === "APPOINTMENT" && <EmployeeAppointmentList />}
                        ...
                        {activeSection === "REVIEWS" && (
                            <div className="h-64 flex items-center justify-center text-white italic">Schedule Management Coming Soon...</div>
                        )}
                    </motion.div>
                </div>
            </main>
